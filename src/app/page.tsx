      ...
      <div className="flex flex-col flex-col-reverse sm:flex-row items-center px-20 py-20">
        <div className="flex-1 flex flex-col gap-20">
          <div>
            ...
            <p className="text-l sm:text-xl">A price predictor tool for residential properties in Pasig and Paranaque city with an emphasis on outdoor property image safety analysis.</p>
          </div>
          <div>
